# This is actually the version adapted to the MATH-500
import argparse
import copy
import json
import numpy as np
...
class ADAS_MATH(MAS):
    ...
    def call_llm(self, prompt=None, system_prompt=None, messages=None):
        response = super().call_llm(prompt=prompt, system_prompt=system_prompt, messages=messages,model_name=self.model_name_optimize)
